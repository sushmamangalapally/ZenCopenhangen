document.addEventListener('DOMContentLoaded', function() {
  ...
  wordOfDayFetch()
  .then((wordJSON) => {
    const [date, word, definitions] = [wordJSON.pdd, wordJSON.word, wordJSON.definitions];
    if (document.querySelector('#word-date')) {
      const convertToDate = new Date(date);
      document.querySelector('#word-date').textContent = convertToDate.toDateString();
    }
    if (document.querySelector('#word')) {
      document.querySelector('#word').textContent = word;
    }
    if (document.querySelector('ul#word-definition')) {
      const list = document.querySelector('ul#word-definition');
